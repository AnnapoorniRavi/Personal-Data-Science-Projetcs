# -*- coding: utf-8 -*-
"""
Created on Wed Jun 10 14:35:56 2020
...
movie_titles = pd.read_csv('C:/Users/Sahi/Desktop/Medium/Reccomendation Engine/Data/Netflix Dataset/movie_titles.csv', 
                           encoding = 'ISO-8859-1', 
                           header = None, 
...
movie_metadata = pd.read_csv('C:/Users/Sahi/Desktop/Medium/Reccomendation Engine/Data/Movies Dataset/movies_metadata.csv', low_memory=False)[['original_title', 'overview', 'vote_count']].set_index('original_title').dropna()
...
df_raw = pd.read_csv('C:/Users/Sahi/Desktop/Medium/Reccomendation Engine/Data/Netflix Dataset/combined_data_1.txt', header=None, names=['User', 'Rating', 'Date'], usecols=[0, 1, 2])
